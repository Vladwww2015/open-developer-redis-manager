...
class RedisController extends BaseController
{
    ...
    public function index()
    {
        return Developer::content(function (Content $content) {
            ...
            $content->body(view('open-developer-redis-manager::index', $vars));
        });
    }
    ...
    public function edit(Request $request)
    {
        return Developer::content(function (Content $content) use ($request) {
            ...
            if (empty($this->data)) {
                $view = 'open-developer-redis-manager::edit.nil';
            } else {
                $view = 'open-developer-redis-manager::form';
            }
    ...
    public function create(Request $request)
    {
        return Developer::content(function (Content $content) use ($request) {
            ...
            //$content->body(view($view, $vars));
            $content->body(view('open-developer-redis-manager::form', $vars));
        });
    }
    ...
    {
        $type = $request->type;
        developer_toastr('Saved', 'success');
    ...
    public function console(Request $request)
    {
        return Developer::content(function (Content $content) use ($request) {
            ...
            $view = 'open-developer-redis-manager::console';
